...
call s:h("Special",       {"fg": s:light_black})
...
hi! link rubyClassBlock                Special
hi! link rubySymbolDelimiter           Special
hi! link rubyCurlyBlockDelimiter       Special
...
" LSP, Treesitter
hi String guisp=#424242 gui=underline guifg=NONE
hi link @string.ruby NONE
hi link @string.content.ruby String
" call s:h("rubyStringDelimiter", {"fg": s:medium_gray, "gui": "none"})
hi link rubyStringDelimiter Special

hi link @lsp.mod.definition @lsp.mod.declaration
hi link rubyMethodName @lsp.mod.declaration
hi @lsp.mod.declaration gui=bold

hi @function.call gui=italic
hi link @lsp.type.method Normal
hi link @string.special.symbol NONE

call s:h("@arguments.first.named", { "fg": s:white, "sp": s:light_black, "gui": "underline" })


hi clear @variable

hi link rubyRegexpDot String
